...
public interface PossivelEscolhaRepository extends JpaRepository<PossivelEscolha, Integer>  {
	...
	public List<PossivelEscolha> buscarRestaurantesNaoVotados(@Param("restaurantesEsquerdo") List<Restaurante> restauranteEsquerdo, @Param("restaurantesDireito") List<Restaurante> restaurantesDireito );
}
